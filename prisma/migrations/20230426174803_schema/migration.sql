...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favioratedById_fkey" FOREIGN KEY ("favioratedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
